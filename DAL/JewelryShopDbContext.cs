...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Bboid).HasName("PK__BuyBackO__7EBCD83691532BBB");
        ...
        {
            entity.HasKey(e => e.BbodetailId).HasName("PK__BuyBackO__9EF99DA86172AA80");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__BuyBackP__2E1339A4C026C16B");
        ...
        {
            entity.HasKey(e => e.CounterId).HasName("PK__Counter__F12879C47DF83209");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64D8F0CF662E");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04F11FF700638");
        ...
        {
            entity.HasKey(e => e.MaterialId).HasName("PK__Material__C50610F77606C9DA");
        ...
        {
            entity.HasKey(e => e.MaterialProductId).HasName("PK__Material__219352D45C219918");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CDA0B0C5C8");
        ...
        {
            entity.HasKey(e => e.PromotionProgramId).HasName("PK__Promotio__7869220A5BACF328");
        ...
        {
            entity.HasKey(e => e.PromotionCodeId).HasName("PK__Promotio__B537DD05E09A9C27");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__ReturnPo__2E1339A445D1E46C");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__8AFACE1AAAE312E0");
        ...
        {
            entity.HasKey(e => e.SaleOrderId).HasName("PK__SaleOrde__DB86E342BB6F461A");
        ...
        {
            entity.HasKey(e => e.SaleOrderDetailId).HasName("PK__SaleOrde__F6EA425A1C704C08");
